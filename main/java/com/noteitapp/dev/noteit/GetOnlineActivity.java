...
public class GetOnlineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadBg = (ViewGroup) findViewById(R.id.download_bg);
        downloadBg.setBackground(getResources().getDrawable(MainActivity.gradients[MainActivity.aTheme]));
        ...
        url.setBackgroundColor(Color.argb(100, 0, 0, 0));
