...
public class DeleteCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteCat = (ViewGroup) findViewById(R.id.delete_cat_bg);
        deleteCat.setBackground(getResources().getDrawable(MainActivity.gradients[MainActivity.aTheme]));
    ...
    class DeleteCategoryAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ViewGroup deleteListBg = (ViewGroup) view.findViewById(R.id.delete_list_bg);
            deleteListBg.setBackgroundColor(Color.parseColor("#33000000"));
